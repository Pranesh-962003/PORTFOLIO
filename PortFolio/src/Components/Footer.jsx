    ...
    <div className='h-[100px] my-2'>
        <div className='bg-secondary h-[100%] pb-2 rounded-md flex '>
          ...
          <div className=' w-full flex items-center justify-center gap-6'>
              <a target='_blank' href="https://www.linkedin.com/in/pranesh-s-cse"><img className='h-7' src="/src/assets/linkedin.svg" alt="" /></a>
              <a target="_blank" href="mailto:pranesh962003.p@gmail.com"><img className='h-7' src="/src/assets/gmail.svg" alt="" /></a>
